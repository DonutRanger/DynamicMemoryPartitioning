...
public class DR_Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("FIXED PARTITION: FIRST FIT ALGORITHM");
        testRun.readJob(Job);
        testRun.readMemory(Partition);
        testRun.FirstFitAlgo(Job, Partition, WaitQueue);

        System.out.println("FIXED PARTITION: BEST FIT ALGORITHM");
    ...
    public void readJob(LinkedList<MemoryJob> job) throws IOException {
        ...
        try {
            ...
            Scanner reader = new Scanner(new File("C:\\Users\\user\\Documents\\NetBeansProjects\\DynamicMemoryPartitioning-master\\DynamicMemoryPartitioning\\src\\dynamicmemorypartitioning\\Haris\\JoblistTest.txt"));
    ...
    public void readMemory(LinkedList<MemoryPartition> memorypartition) {
        try {
            ...
            Scanner reader = new Scanner(new File("C:\\Users\\user\\Documents\\NetBeansProjects\\DynamicMemoryPartitioning-master\\DynamicMemoryPartitioning\\src\\dynamicmemorypartitioning\\Haris\\MemoryListTest.txt"));
            while (reader.hasNextLine()) {
                skip(reader, 1);
                if (reader.hasNextInt()) {
                    temp1 = reader.nextInt();
